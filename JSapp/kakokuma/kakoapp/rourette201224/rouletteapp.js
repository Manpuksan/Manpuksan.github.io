...
const betCReset =(n)=>{
  ...
  if(n>1 && n<38 && betAtari[150].atari.indexOf(parseInt(bet[n].textContent))!==-1){
    document.getElementsByClassName('bet')[n].style.backgroundColor='red'
  }
  else if(n>1 && n<38 && betAtari[151].atari.indexOf(parseInt(bet[n].textContent))!==-1){
    document.getElementsByClassName('bet')[n].style.backgroundColor='black'
  }else if(n>37 && n<140){
    document.getElementsByClassName('bet')[n].style.backgroundColor='white'
  }else{
    document.getElementsByClassName('bet')[n].style.backgroundColor='green'
  }
};
const newgame = ()=>{
  kakekinreset();
...
const betOkane =(n)=>{
  ...
  if(betAtari[n].kakekin===0){let w = Math.floor(Math.random()*hiyakasi.length);
    ...
    document.getElementsByClassName('bet')[n].style.backgroundColor='gold'
    betAtari[n].betp=1;
  }
}
  ...
  const result=()=>{
    ...
    for(hn=0;hn<152;hn++){
      if(betAtari[hn].win===1 && betAtari[hn].betp===1){
        document.getElementsByClassName('bet')[hn].style.backgroundColor='lightgreen'
        betAtari[hn].win=0;
        betAtari[hn].betp=0;}
    }
    }
